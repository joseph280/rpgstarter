...
namespace RPGStarter.EditorTools
{
    ...
    public static class W2_WeaponBuilder
    {
        ...
        // "RPGStarter → Demo → 1. Build Primitive Source Assets" before this builder.
        ...
        public static void Build()
        {
            ...
            if (shotAbility == null)
                Debug.LogWarning("[W2_WeaponBuilder] BasicShot ability not found — Bow weapon will reference null. Run RPGStarter/W2/1 first.");
            ...
            if (slashClip == null) Debug.LogError("[W2_WeaponBuilder] Slash clip missing — run RPGStarter/W2/2 first.");
            if (bowClip   == null) Debug.LogError("[W2_WeaponBuilder] Bow clip missing — run RPGStarter/W2/2 first.");
